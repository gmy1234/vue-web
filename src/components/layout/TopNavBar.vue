  ...
  <v-app-bar app :class="navClass" hide-on-scroll flat height="60">
    ...
    <div class="d-md-block d-none nav-container">
      <div class="float-left blog-title">
        <router-link to="/">关梦洋</router-link>
      </div>
      <div class="float-right nav-title">
        ...
        <div class="menus-item">
          <router-link class="menu-btn" to="/">
            <icon-font type="home"/>首页
          </router-link>
        </div>
        <div class="menus-item">
          <a class="menu-btn">
            <icon-font type="discover"/>发现
        ...
        <div class="menus-item">
          ...
          <icon-font type="about"/> 关于
          </router-link>
        </div>
        <div class="menus-item">
          <router-link class="menu-btn" to="/message">
            <icon-font type="message"/> 留言
          </router-link>
        </div>
        <div class="menus-item">
          <a class="menu-btn"><icon-font type="login"/> 登录</a>
        </div>
      </div>
    </div>
  </v-app-bar>
