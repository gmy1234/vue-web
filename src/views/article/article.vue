      ...
      <div class="article-info-container">
        ...
        <div class="article-info">
          ...
          <div class="third-line">
            ...
            <!-- 阅读量 -->
            <span>
              <i class="iconfont" /> 阅读量: {{ article.viewsCount }}
            </span>
            <span class="separator">|</span>
            <!-- 评论量 -->
            <span>
              <i class="iconfont" />评论数: {{ commentCount }}
            </span>
          </div>
        </div>
      </div>
        ...
        <div style="position: sticky;top: 20px;">
          ...
          <v-card class="right-container">
            <div class="right-title">
              <i class="iconfont" style="font-size:16.8px" />
...
export default {
  ...
  computed: {
    ...
    articleCover() {
      return (
          "background: url(" +this.article.articleCover + ") center center / cover no-repeat"
      );
    },
    isLike() {
  ...
  methods:{
    ...
    like() {
      ...
      //发送请求
      this.axios.post("/api/article/" + this.article.id + "/like").then(({ data }) => {
        if (data.flag) {
          //判断是否点赞
          if (
